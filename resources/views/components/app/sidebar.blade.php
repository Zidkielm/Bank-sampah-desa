        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <a class="flex items-center" href="/">
                ...
                <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                    <span class="text-gray-800 dark:text-gray-100 font-bold text-sm block">Bank Sampah</span>
                    <span class="text-gray-800 dark:text-gray-100 font-bold text-sm block">Sumber Pawana</span>
                </div>
            </a>
        </div>
