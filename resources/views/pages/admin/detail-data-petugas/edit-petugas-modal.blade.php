<div x-show="showEditModal"
    ...
    <div class="flex items-center justify-center min-h-screen px-4 text-center sm:block sm:p-0 relative z-50">
        <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
            ...
            <form x-bind:action="'{{ route('admin.petugas.update', '') }}/' + selectedUser.id" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="w-full">
                            <div class="flex justify-between items-center mb-4">
                                <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100">Edit Petugas</h3>
                            ...
                            <div class="mb-4">
                                <label for="edit-name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama <span class="text-red-500">*</span></label>
                            ...
                            <div class="mb-4">
                                <label for="edit-username" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Username <span class="text-red-500">*</span></label>
                                <input type="text" name="username" id="edit-username" required x-model="selectedUser.username"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600
                                    shadow-sm focus:border-orange-500 focus:ring focus:ring-orange-500 focus:ring-opacity-50
                                    dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="edit-no_hp" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nomor HP <span class="text-gray-400 dark:text-gray-500">(opsional)</span></label>
                            ...
                            <div class="mb-4">
                                <label for="edit-alamat" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Alamat <span class="text-gray-400 dark:text-gray-500">(opsional)</span></label>
                            ...
                            <div class="mb-4">
                                <label for="edit-password" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Password <span class="text-gray-400 dark:text-gray-500">(kosongkan jika tidak ingin mengubah)</span></label>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2">
                                    <div class="flex items-center">
                                        <input type="radio" id="status-active" name="status" value="active" x-model="selectedUser.status"
                                    ...
                                    <div class="flex items-center mt-2">
                                        <input type="radio" id="status-inactive" name="status" value="inactive" x-model="selectedUser.status"
                                               class="focus:ring-orange-500 h-4 w-4 text-orange-600 border-gray-300 dark:border-gray-600">
