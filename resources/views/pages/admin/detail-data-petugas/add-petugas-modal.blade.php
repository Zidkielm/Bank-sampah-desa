<div x-show="showModal"
    ...
    <div class="flex items-center justify-center min-h-screen px-4 text-center sm:block sm:p-0 relative z-50">
        <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
            ...
            <form action="{{ route('admin.petugas.store') }}" method="POST" x-data="{ showPassword: false }">
                @csrf
                <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div class="w-full">
                            <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100 mb-4">Tambah Data Petugas</h3>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative mt-1 flex">
                                    ...
                                    <div class="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer" @click="showPassword = !showPassword">
                                        <i x-show="!showPassword" data-feather="eye" class="h-5 w-5 text-gray-400 hover:text-gray-600"></i>
                                        <i x-show="showPassword" data-feather="eye-off" class="h-5 w-5 text-gray-400 hover:text-gray-600"></i>
                                    </div>
                                </div>
                                <div class="mt-2">
                                    <button
                            ...
                            <div class="mb-4">
                                <label for="alamat" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Alamat <span class="text-gray-400 dark:text-gray-500">(opsional)</span></label>
