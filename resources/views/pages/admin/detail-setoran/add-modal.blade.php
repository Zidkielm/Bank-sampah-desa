                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="w-full">
                            <div class="flex justify-between items-center mb-4">
                                <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100">Tambah Setoran</h3>
                            ...
                            <div class="mb-4">
                                <label for="user_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nasabah <span class="text-red-500">*</span></label>
                            ...
                            <div class="mb-4">
                                <label for="deposit_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal Setoran <span class="text-red-500">*</span></label>
                            ...
                            <div class="mb-4">
                                <div class="flex justify-between mb-2">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Daftar Sampah <span class="text-red-500">*</span></label>
                                    <button type="button" @click="addWasteItem()" class="text-orange-500 hover:text-orange-600 focus:outline-none text-sm flex items-center">
                                ...
                                <template x-for="(item, index) in wasteItems" :key="index">
                                    <div class="p-3 mb-3 border border-gray-200 dark:border-gray-700 rounded-lg">
                                        <div class="flex justify-between items-center mb-2">
                                            <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300">Item #<span x-text="index + 1"></span></h4>
                                            <button type="button" @click="removeWasteItem(index)" class="text-gray-400 hover:text-gray-500 focus:outline-none" x-show="wasteItems.length > 1">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
                                            <div>
                                                <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Jenis Sampah <span class="text-red-500">*</span></label>
                                                <select
                                                    :name="'items['+index+'][waste_type_id]'"
                                                    x-model="item.waste_type_id"
                                                    @change="getWasteTypePrice(index)"
                                                    required
                                            ...
                                            <div>
                                                <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Berat (KG) <span class="text-red-500">*</span></label>
                                                <input
                                                    type="number"
                                                    :name="'items['+index+'][weight_kg]'"
                                                    x-model="item.weight_kg"
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Harga per KG</label>
                                                <div class="relative">
                                            ...
                                            <div>
                                                <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Total Harga</label>
                                                <div class="relative">
                                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                                        <span class="text-gray-500 dark:text-gray-400 sm:text-sm">Rp</span>
                                                    </div>
                                ...
                                <div class="mt-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    <div class="flex justify-between items-center">
                                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Total Setoran</span>
                                        <span x-text="formatPrice(calculateGrandTotal())" class="text-lg font-semibold text-gray-800 dark:text-gray-100"></span>
                                    </div>
                                </div>
                            </div>

                            <div class="mb-4">
                                <label for="notes" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Catatan <span class="text-gray-400 dark:text-gray-500">(opsional)</span></label>
