                ...
                <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-5">
                    <div class="flex items-center">
                        <div class="ml-5 mr-auto">
                            ...
                            <p class="text-lg text-gray-800 dark:text-gray-100 font-semibold">{{ number_format($totalNasabah) }}</p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-5">
                    <div class="flex items-center">
                        <div class="ml-5 mr-auto">
                            ...
                            <p class="text-lg text-gray-800 dark:text-gray-100 font-semibold">{{ number_format($totalPetugas) }}</p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-5">
                    <div class="flex items-center">
                        <div class="ml-5 mr-auto">
                            ...
                            <p class="text-lg text-gray-800 dark:text-gray-100 font-semibold">Rp. {{ number_format($totalSaldo, 0, ',', '.') }}</p>
                        </div>
