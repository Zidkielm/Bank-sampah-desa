                ...
                <div class="sm:flex sm:items-start">
                    <div class="w-full">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100">Detail Nasabah</h3>
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 py-4">
                            <dl>
                                <div class="grid grid-cols-3 gap-4 py-3">
                                    ...
                                    <dd class="text-sm text-gray-900 dark:text-gray-200 col-span-2" x-text="selectedUser.name"></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Username</dt>
                                    <dd class="text-sm text-gray-900 dark:text-gray-200 col-span-2" x-text="selectedUser.username"></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Alamat</dt>
                                    <dd class="text-sm text-gray-900 dark:text-gray-200 col-span-2" x-text="selectedUser.alamat || 'Tidak ada alamat'"></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">No. HP</dt>
                                    <dd class="text-sm text-gray-900 dark:text-gray-200 col-span-2" x-text="selectedUser.no_hp || 'Tidak ada'"></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Saldo</dt>
                                    <dd class="text-sm text-gray-900 dark:text-gray-200 col-span-2" x-text="'Rp ' + formatNumber(selectedUser.saldo)"></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                ...
                                <div class="grid grid-cols-3 gap-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <dd class="text-sm text-gray-900 dark:text-gray-200 col-span-2" x-text="formatDate(selectedUser.created_at)"></dd>
                                </div>
                            </dl>
                        </div>
                    </div>
