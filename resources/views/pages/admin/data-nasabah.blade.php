                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4">Jl.hayam wuruk</td>
                            <td class="px-4 py-4">Rp 40.000</td>
                            <td class="px-4 py-4">
                                <span class="px-3 py-1 text-white bg-emerald-500 rounded-full text-xs">Aktif</span>
                            </td>
                            <td class="px-4 py-4">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4">Jl.Mahakan</td>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4">Jl.Lamongan</td>
                            <td class="px-4 py-4">Rp 20.000</td>
                            <td class="px-4 py-4">
                                <span class="px-3 py-1 text-white bg-pink-500 rounded-full text-xs">Tidak aktif</span>
                            </td>
                            <td class="px-4 py-4">
                                <div class="flex space-x-2">
                                    <button class="p-1 rounded-lg hover:bg-gray-100">
