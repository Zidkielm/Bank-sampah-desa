                ...
                <div class="sm:flex sm:items-start">
                    <div class="w-full">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100">Detail Sampah</h3>
                            <button @click="showDetailModal = false" class="text-gray-400 hover:text-gray-500 focus:outline-none">
                                <i data-feather="x" class="h-6 w-6"></i>
                            </button>
                        </div>

                        <div class="text-center mb-4" x-show="selectedWaste.image_path">
                            <img :src="'/storage/' + selectedWaste.image_path" :alt="selectedWaste.name" class="w-32 h-32 object-cover rounded-lg mx-auto">
                        </div>

                        <div class="border-t border-gray-200 dark:border-gray-700 py-4">
                            <dl>
                                <div class="grid grid-cols-3 gap-4 py-3">
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Nama Sampah</dt>
                                    <dd class="text-sm text-gray-900 dark:text-gray-200 col-span-2" x-text="selectedWaste.name"></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <dd class="text-sm text-gray-900 dark:text-gray-200 col-span-2" x-text="formatPrice(selectedWaste.price_per_kg)"></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Status</dt>
                                    <dd class="text-sm col-span-2">
                                        <template x-if="selectedWaste.status === 'active'">
                                            <span class="inline-flex px-3 py-1 text-xs text-white bg-emerald-500 rounded-full">Aktif</span>
                                        </template>
                                        <template x-if="selectedWaste.status === 'inactive'">
                                ...
                                <div class="grid grid-cols-3 gap-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <dd class="text-sm text-gray-900 dark:text-gray-200 col-span-2" x-text="selectedWaste.description || 'Tidak ada deskripsi'"></dd>
                                </div>
                            </dl>
                        </div>
                    </div>
