                ...
                <div class="sm:flex sm:items-start">
                    <div class="w-full">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100">Detail Sampah
                            </h3>
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 py-4">
                            <dl>
                                ...
                                <div class="grid grid-cols-3 gap-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <dd class="text-sm text-gray-900 dark:text-gray-200 col-span-2"
                                        x-text="formatPrice(selectedWaste.price_per_kg)"></dd>
                                </div>
                                <div class="grid grid-cols-3 gap-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                ...
                                <div class="grid grid-cols-3 gap-4 py-3 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <dd class="text-sm text-gray-900 dark:text-gray-200 col-span-2"
                                        x-text="selectedWaste.description || 'Tidak ada deskripsi'"></dd>
                                </div>
                            </dl>
                        </div>
                    </div>
