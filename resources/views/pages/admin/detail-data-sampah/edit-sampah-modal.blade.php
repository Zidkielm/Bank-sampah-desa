<div x-show="showEditModal"
    ...
    <div class="flex items-center justify-center min-h-screen px-4 text-center sm:block sm:p-0 relative z-50">
        <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
            ...
            <form x-bind:action="'{{ route('admin.waste-types.update', '') }}/' + selectedWaste.id" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="w-full">
                            <div class="flex justify-between items-center mb-4">
                                <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100">Edit Sampah</h3>
                            ...
                            <div class="mb-4">
                                <label for="edit-name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama Sampah <span class="text-red-500">*</span></label>
                                <input type="text" name="name" id="edit-name" required x-model="selectedWaste.name"
                            ...
                            <div class="mb-4">
                                <label for="edit-price_per_kg" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Harga per KG <span class="text-red-500">*</span></label>
                                <div class="relative mt-1">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <span class="text-gray-500 dark:text-gray-400 sm:text-sm">Rp</span>
                                    </div>
                                    <input type="number" name="price_per_kg" id="edit-price_per_kg" required x-model="selectedWaste.price_per_kg"
                            ...
                            <div class="mb-4">
                                <label for="edit-image" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Gambar <span class="text-gray-400 dark:text-gray-500">(kosongkan jika tidak ingin mengubah)</span></label>
                                ...
                                <div class="mt-2" x-show="selectedWaste.image_path">
                                    ...
                                    <img :src="'/storage/' + selectedWaste.image_path" :alt="selectedWaste.name" class="h-24 object-cover rounded">
                                </div>
                            </div>

                            <div class="mb-4">
                                <label for="edit-description" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Deskripsi <span class="text-gray-400 dark:text-gray-500">(opsional)</span></label>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2">
                                    <div class="flex items-center">
                                        <input type="radio" id="status-active" name="status" value="active" x-model="selectedWaste.status"
                                    ...
                                    <div class="flex items-center mt-2">
                                        <input type="radio" id="status-inactive" name="status" value="inactive" x-model="selectedWaste.status"
                                               class="focus:ring-orange-500 h-4 w-4 text-orange-600 border-gray-300 dark:border-gray-600">
