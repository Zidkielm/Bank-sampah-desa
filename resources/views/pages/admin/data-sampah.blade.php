<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Data Sampah</h1>
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4">Sampah Plastik</td>
                            <td class="px-4 py-4">Rp 5.000</td>
                            <td class="px-4 py-4">
                                <img src="/img/sampah-plastik.jpg" alt="Sampah Plastik" class="w-16 h-16 object-cover rounded">
                            </td>
                            <td class="px-4 py-4">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4">Sampah Kertas</td>
                            <td class="px-4 py-4">Rp 3.500</td>
                            <td class="px-4 py-4">
                                <img src="/img/sampah-kertas.jpg" alt="Sampah Kertas" class="w-16 h-16 object-cover rounded">
                            </td>
                            <td class="px-4 py-4">
                                <div class="flex space-x-2">
                                    <button class="p-1 rounded-lg hover:bg-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4">Sampah Logam</td>
                            <td class="px-4 py-4">Rp 12.000</td>
                            <td class="px-4 py-4">
                                <img src="/img/sampah-logam.jpg" alt="Sampah Logam" class="w-16 h-16 object-cover rounded">
                            </td>
                            <td class="px-4 py-4">
                                <div class="flex space-x-2">
                                    <button class="p-1 rounded-lg hover:bg-gray-100">
