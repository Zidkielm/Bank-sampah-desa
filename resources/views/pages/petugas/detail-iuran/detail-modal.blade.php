        ...
        <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
            ...
            <div class="bg-gray-50 dark:bg-gray-800 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                ...
                <div class="flex space-x-2">
                    <form x-show="selectedFee.status === 'unpaid'" action="{{ route('petugas.monthly-fee.approve', '') }}" method="POST" class="inline" x-ref="approveForm">
                        @csrf
                        <button type="button" @click="$refs.approveForm.action = '{{ route('petugas.monthly-fee.approve', '') }}/' + selectedFee.id; $refs.approveForm.submit();"
