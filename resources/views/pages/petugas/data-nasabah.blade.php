<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto" x-data="{
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <div class="mb-6">
                <form action="{{ route('petugas.data-nasabah') }}" method="GET">
                    <div class="relative">
        ...
        @include('pages.petugas.detail-data-nasabah.add-nasabah-modal')
        @include('pages.petugas.detail-data-nasabah.view-nasabah-modal')
        @include('pages.petugas.detail-data-nasabah.edit-nasabah-modal')
        @include('pages.petugas.detail-data-nasabah.delete-nasabah-modal')
    </div>
</x-app-layout>
