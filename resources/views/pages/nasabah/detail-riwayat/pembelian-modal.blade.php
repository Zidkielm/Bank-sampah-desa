                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-md p-4 mb-4 space-y-2">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100"
                                    x-text="selectedWithdrawal.id ? `#${selectedWithdrawal.id}` : '-'"></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-500 dark:text-gray-400">Tanggal:</span>
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100"
                                    x-text="formatDate(selectedWithdrawal.withdrawal_date)"></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-500 dark:text-gray-400">Total Belanja:</span>
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100"
                                    x-text="formatPrice(selectedWithdrawal.total_amount)"></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-500 dark:text-gray-400">Pembayaran Dari Saldo:</span>
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100"
                                    x-text="formatPrice(selectedWithdrawal.amount)"></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-500 dark:text-gray-400">Pembayaran Tunai:</span>
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100"
                                    x-text="formatPrice(selectedWithdrawal.cash_amount)"></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-500 dark:text-gray-400">Diproses Oleh:</span>
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100"
                                    x-text="selectedWithdrawal.processor?.name || '-'"></span>
                            </div>
                            <div class="flex justify-between items-center" x-show="selectedWithdrawal.notes">
                                <span class="text-sm text-gray-500 dark:text-gray-400">Catatan:</span>
                                <span class="text-sm font-medium text-gray-900 dark:text-gray-100"
                                    x-text="selectedWithdrawal.notes || '-'"></span>
                            </div>
                        </div>

                        <div class="border-t dark:border-gray-700 pt-4 mb-4">
                            <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Detail Pembelian</h4>
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-md p-4">
                                <table class="w-full text-sm">
                                    ...
                                    <tbody class="text-gray-900 dark:text-gray-100">
                                        <template x-for="item in selectedWithdrawal.items" :key="item.id">
                                            <tr>
                                                <td class="py-1" x-text="item.item_name"></td>
                                                <td class="py-1 text-center" x-text="item.quantity"></td>
                                                <td class="py-1 text-right" x-text="formatPrice(item.price)"></td>
                                                <td class="py-1 text-right" x-text="formatPrice(item.total_amount)"></td>
                                            </tr>
                                        </template>
                                    </tbody>
                                </table>
                        ...
                        <div class="border-t dark:border-gray-700 pt-4">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-md p-4 space-y-2">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-sm font-medium text-gray-900 dark:text-gray-100"
                                        x-text="selectedWithdrawal.transaction ? formatPrice(selectedWithdrawal.transaction.balance_after) : '-'"></span>
                                </div>
                            </div>
                        </div>
                    </div>
